...
import sys
caffe_root = '/home/analogicalnexus/caffe/'  # this file should be run from {caffe_root}/examples (otherwise change this line)
...
#image = caffe.io.load_image(caffe_root + 'examples/images/dataset_224/09.jpg')
